...
Try {
	...
	[string]$appVendor = 'PRABI-Doua'
	[string]$appName = 'Seaview'
	[string]$appVersion = '5'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '8/11/2022'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		Show-InstallationWelcome -CloseApps 'seaview' -CheckDiskSpace -PersistPrompt

		## Show Progress Message (with the default message)
		Show-InstallationProgress

		## <Perform Pre-Installation tasks here>
		Copy-File -Path $dirFiles\seaview5\ -Destination $envProgramFiles -Recurse
		Copy-File -Path $dirSupportFiles\seaview.lnk -Destination $envCommonDesktop
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'seaview' -CloseAppsCountdown 60
		...
		Remove-File -Path $envProgramFiles\seaview5\ -Recurse
		Remove-File -Path $envCommonDesktop\seaview.lnk
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCqb1fomvPL8l36
# 46GorjqkPqC9/gXh5+VasSef+gM+7KCCH8EwggVvMIIEV6ADAgECAhBI/JO0YFWU
...
# AYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgVwRCKpSK2wmD
# fqpMScRA35pkol8bLJwP6pZtpPNr90MwDQYJKoZIhvcNAQEBBQAEggGARncjxVIO
# QVE+122FulpMcKqEQEnhpY8kPlkwQxL2jgLmm4pGyXEkRZhZnRaelT16oCFhDwJG
# xwVgWJVYIIrr/E9nRjo8C9fbaSw0w7TUuEwWgU3CXC5kVVkPxe9cPXbjsJyk+D98
# J54U6bipOVy1tofGydJdbKzaTUQwPEUNYWxtSTZyLYENdecQqzbpPfz9GmbHAVL2
# MVtUm5UYqasAtTeUTp+Ed+C2cDe4pUil5x9gkBZO71uw8byF+6uIrLpoc417r9S+
# mgdL71z69Ptq4a9rXuKkCLgLuF02A8lOk6TQKKFNOhYqwUrKwbecqCqa3ONjbHHJ
# WWDR9TFeE03NkIpQpAvP99ZCeGwh2pv2SACo2gGhSroHL9x9lgPU7y1eSHOWHs/i
# yeqljwiVNS94FVaXsfyfwsQZfqXVBO5v4WgEREXFAQJS/EZgQBlbOSexbZ33pHjN
# HNU8BinLVvvFh31sK4BsGPOf3kd5eZ/Ag14q2VNcbWjqoYVf0TBPNWOGoYIDTDCC
...
# BgkqhkiG9w0BCQMxCwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yMjA4MTEx
# NzAxNDRaMD8GCSqGSIb3DQEJBDEyBDD8cgbvM2K9Of/O8Ek6XbsDxeUgzHBumx1h
# tD8oG09St0QbSge3fEHJIP/DN6wBfyMwDQYJKoZIhvcNAQEBBQAEggIAPjUuySDy
# FsFpd9IeMOG1TUliVzrvgUJ1tukSWWytnvNTDQLGLhosws0RBrSj4sWWjobZxxw1
# uWhIU8+VGrTBQH6jDQVbljiBeBAu4DA3WvdHT+IEghDXPw7/9uIO9H4lqgqbAk19
# OjbJyTBhBTFDRiqvNJ+YOe9jTqgVRWL+DXk/IdPdOrohEqig5eM9YTGPcT/6A5DM
# 5a78R8V4nNkIPIE6INXTknaloq47eCYc0ndWfhF57c/qYzeX7XoDt0I/xSE6KHGb
# XY/3eriOjgaj0OWzTCqJv5s7My91cFbndhnsDCqU6duWsjwLZIfdTEjWhnZfaFWI
# XJGYAMCQf5gwm6IMpWpTxmzJgzXt3cbWfIUOg+TywHd1OOqsWAYeSVqNNq4fpAHe
# kB+OEOIcqfhAztZ0hblri8hfzXRh06HGldZD1ndIAKHgNzKkZsW7uYx1ufoMVFg1
# 0y2/uncNxgCSB6BCFNuHsh7fWWNXMgrd2rbxs4DCySNI2LXGHHBuMNU0Beh4KPOv
# Iock8eiRrGlbMtXjvOCqd9YKv8zhiTNLwxcjMr89kZdiWZ8qU/PgDJhQF3qIysn9
# Qyaep6KR3rBFfdqQ5f9Atf18fyB02paosecNTCLz47sUCT+kvgqQg8YEyrsKrT9x
# Zi0nuQyWT8ytWFGk82FSDMa8Osvbkgf8Mnw=
